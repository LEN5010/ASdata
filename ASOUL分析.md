...
如果把嘉然所有类型(包括3D/突击)合并看，后续去过嘉然直播的人群占 source：`63.42%`
...
如果把贝拉所有类型(包括3D/突击)合并看，后续去过贝拉直播的人群占 source：`20.05%`
...
如果把乃琳 source 之后的其他类型直播(3D/突击)合并看，后续去过乃琳其他直播的潮u占 source：`39.70%`
...
其次，`乃琳+嘉然` 与 `三人都看` 两项合计超过三成，说明相当一部分人正在逐步扩展成**多人团推**。
...
贝拉主要承接流量方式是 `终末地`，本身也是游戏向内容，它确实能接住一部分鸣潮用户。
...
在这个窗口里，琳姐确实像一个入口：她把一批又一批潮u带进来；而潮u们(也许现在应该叫ak们)并没有停在单点，而是在团内继续流动、继续连接，最后慢慢长成“团推”的结构。
有人留下，有人外溢，有人转化为团推，所以，比起“谁赢谁输”，我更愿意把这段时间理解为：
 **乃琳点燃了入口，嘉然放大了承接，贝拉仍在追赶中寻找自己的节奏，而团体整体在逆风里重新长出活力。**
